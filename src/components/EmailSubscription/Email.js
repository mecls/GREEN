...
return(
    <div className='pa4-l'>
        <form className="bg-tcolor-green mw7 center pa4 br2-ns ba b--black-10">
            <fieldset className="cf bn ma0 pa0">
                ...
                <input className="f6 f5-l button-reset fl pv3 tc bn bg-animate bg-tcolor-70 hover-bg-black white pointer w-100 w-25-m w-20-l br2-ns br--right-ns" type="submit" value="Subscribe"/>
                </div>
            </fieldset>
        </form> 
    </div>
