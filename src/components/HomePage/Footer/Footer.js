...
return(
    ...
    <div className="mx-auto max-w-screen-xl">
            ...
            <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                ...
                <div>
                    ...
                    <ul className="text-gray-600 dark:text-gray-400">
                        ...
                        <li>
                            <a href="#0" class="hover:underline">Terms &amp; Conditions</a>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
            <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="#0" className="hover:underline">Green</a>. All Rights Reserved.
            </span>
