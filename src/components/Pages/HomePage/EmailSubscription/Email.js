...
//                       <input onChange={(e) => setEmail(e.target.value)} className="block p-3 pl-10 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 sm:rounded-none sm:rounded-l-lg focus:ring-primary-900 focus:border-primary-900 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-900 dark:focus:border-primary-900" placeholder="Enter your email" type="email" id="email" required={true}/>
//                   </div>
//                   <div>
...
// </section> 
// </div>
<iframe src="https://embeds.beehiiv.com/11b164d0-afd0-4f33-8b75-cce22f2e27eb" data-test-id="beehiiv-embed" width="100%" height="320" frameborder="0" scrolling="no" style={{borderRadius: '4px', border: '2px solid #e5e7eb', margin: '0', backgroundColor: 'transparent'}}></iframe>
